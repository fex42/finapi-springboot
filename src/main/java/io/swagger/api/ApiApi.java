...
import io.swagger.model.UserParamsImpl;
...
import io.swagger.model.UpdateAllTransactionsParams;
...
public interface ApiApi {
    ...
    @ApiOperation(value = "Create a new user", notes = "Create a new user. Must pass your global (i.e. client) access_token. This service returns the user's password as plain text.", response = User.class, tags={ "Users", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/api/v1/users",
        method = RequestMethod.POST)
    ResponseEntity<User> createUser(@ApiParam(value = "User's details" ,required=true ) @RequestBody UserParamsImpl body);
    ...
    @ApiOperation(value = "Delete a user", notes = "Delete a single user. Only an authorized user can delete himself. ATTENTION: This deletes the user including all of his bank connections, accounts, balance data and transactions! THIS PROCESS CANNOT BE UNDONE! Note that a user cannot get deleted while any of his bank connections are currently busy (in the process of import, update, or transactions categorization).", response = Void.class, authorizations = {
        @Authorization(value = "finapi_auth", scopes = {
            @AuthorizationScope(scope = "all", description = "modify any sources")
            })
    }, tags={ "Users", })
    ...
    @ApiOperation(value = "Get a user", notes = "Get the authorized user's data. Only the authorized user can get his data, i.e. his access_token must be used. Note that each symbol of the password is distorted with an 'X' character, i.e. if the user's password is '12345', the service will return the string 'XXXXX'.", response = User.class, authorizations = {
        @Authorization(value = "finapi_auth", scopes = {
            @AuthorizationScope(scope = "all", description = "modify any sources")
            })
    }, tags={ "Users", })
    ...
    @ApiOperation(value = "Get multiple transactions", notes = "Get a list of multiple transactions of the user that is authorized by the access_token. Must pass the transactions' identifiers and the user's access_token. Transactions whose identifiers do not exist or do not relate to the authorized user will not be contained in the result (If this applies to all of the given identifiers, then the result will be an empty list). WARNING: This service is deprecated and will be removed at some point. If you want to get multiple transactions, please instead use the service 'Get and search all transactions' and pass a comma-separated list of identifiers as a parameter 'ids'.", response = TransactionList.class, authorizations = {
        @Authorization(value = "finapi_auth", scopes = {
            @AuthorizationScope(scope = "all", description = "modify any sources")
            })
    }, tags={ "Transactions", })
    ...
    ResponseEntity<IdentifierList> patchAllTransactions(@ApiParam(value = "Update transactions parameters" ,required=true ) @RequestBody UpdateAllTransactionsParams body);
    ...
    @RequestMapping(value = "/api/v1/transactions/{ids}",
        method = RequestMethod.PATCH)
    ResponseEntity<IdentifierList> patchTransactions(@ApiParam(value = "Comma-separated list of identifiers of updated transactions",required=true ) @PathVariable("ids") List<Long> ids,@ApiParam(value = "Update transactions parameters" ,required=true ) @RequestBody UpdateSpecificTransactionsParams body);


    @ApiOperation(value = "Edit a user", notes = "Change the email address and/or phone number of a user. Pass an empty string (but not null) to unset either the email or phone number. At least one field must have a non-null value in the request body. Only the authorized user can edit his data, i.e. his access_token must be used. This service returns the user's password in distorted form.", response = User.class, authorizations = {
        @Authorization(value = "finapi_auth", scopes = {
            @AuthorizationScope(scope = "all", description = "modify any sources")
            })
    }, tags={ "Users", })
    ...
    @RequestMapping(value = "/api/v1/users",
        method = RequestMethod.PATCH)
    ResponseEntity<User> patchUser(@ApiParam(value = "User's details" ,required=true ) @RequestBody UserParamsImpl body);
