...
public class ApiApiController implements ApiApi {
    ...
    public ResponseEntity<User> createUser(@ApiParam(value = "User's details" ,required=true ) @RequestBody UserParamsImpl body) {
        // do some magic!
    ...
    public ResponseEntity<IdentifierList> patchAllTransactions(@ApiParam(value = "Update transactions parameters" ,required=true ) @RequestBody UpdateAllTransactionsParams body) {
        // do some magic!
        return new ResponseEntity<IdentifierList>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<Transaction> patchTransaction(@ApiParam(value = "Identifier of transaction",required=true ) @PathVariable("id") Long id,
        @ApiParam(value = "Update transactions parameters" ,required=true ) @RequestBody UpdateSpecificTransactionsParams body) {
        // do some magic!
        return new ResponseEntity<Transaction>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<User> patchUser(@ApiParam(value = "User's details" ,required=true ) @RequestBody UserParamsImpl body) {
        // do some magic!
        return new ResponseEntity<User>(HttpStatus.OK);
    }
